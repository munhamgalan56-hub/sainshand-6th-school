...
export default function HeroSection() {
  return (
    <section style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto', padding: '100px 32px 80px', color: '#fff' }}>
      {/* Background orbs */}
      ...
      <div style={{ maxWidth: 600 }}>
        ...
        <h1 style={{ fontFamily: 'Playfair Display, serif', fontSize: 'clamp(36px, 5vw, 56px)', fontWeight: 800, lineHeight: 1.15, marginBottom: 20 }}>
          Ирээдүйг <span style={{ color: '#b49eff' }}>чанартай</span><br />боловсролоор бүтээе
        </h1>

        <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.65)', lineHeight: 1.75, maxWidth: 440, marginBottom: 36 }}>
          Сайншанд сумын 6-р сургууль — орчин үеийн технологи, туршлагатай багш нарын хамт таны хүүхдийн ирээдүйг хөгжүүлнэ.
        </p>

        {/* Энд товчлууруудыг Link болгож өөрчлөв */}
